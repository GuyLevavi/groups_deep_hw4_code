...
if __name__ == '__main__':
    ...
    models = [StandardNetwork(n, 1),
              CanonizationNetwork(n),
              SymmetrizationNetwork(n, 1, 100),
              IntrinsicNetwork(n, 1)]
    ...
    for model in models:
        ...
        trainer = L.Trainer(max_epochs=2000, logger=wandb_logger, callbacks=[early_stopping], check_val_every_n_epoch=5, log_every_n_steps=1)
